...
import EditRoleAccess from "./pages/settings/EditRoleAccess";
  ...
  return (
    <div className="min-h-full flex flex-col">
      <Routes>
        ...
        />
        <Route
          path="/asset-tools/Detail-transfer/:transHId"
          element={<DetailTransferAsset />}
        />

        <Route
          path="/asset-tools/Detail-Return/:transHId"
          element={<DetailReturnAsset />}
        />
        <Route
          path="/setting/role-access/:roleId"
          element={<SideBar element={<EditRoleAccess />} />}
        />
        {/* <Route  */}
      </Routes>
    </div>
