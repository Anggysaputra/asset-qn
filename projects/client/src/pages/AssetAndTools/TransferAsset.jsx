...
const TransferAsset = () => {
  ...
  const detailAsset = useSelector((state) => state.transferAsset);
  ...
  useEffect(() => {
    if (opeModalConfirmed) {
      dispatch(fetchDetailTransfer(noIdTH));
    }
  }, [opeModalConfirmed]);
    ...
    <div>
      ...
      <div>
        <Modal3
          ...
          children={
            <ConfirmedTransferAssetForm
              detailData={detailAsset.detailTransfer}
            />
          }
        />
      </div>
      ...
      <Table
        ...
        tableBody={
          <TableBodyTransferAsset
            asset={transferGlobal.transAsset.transAsset}
