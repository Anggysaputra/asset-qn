...
const ReturnAsset = () => {
  ...
  const detailAsset = useSelector((state) => state.returnAsset);
  ...
  useEffect(() => {
    if (opeModalConfirmed) {
      dispatch(fetchDetailReturn(noIdTH));
    }
  }, [opeModalConfirmed]);
    ...
    <div>
      ...
      <div>
        <Modal3
          ...
          children={
            <ConfirmedReturnAssetForm detailData={detailAsset.detailReturn} />
          }
        />
      </div>
          ...
          <Table
            ...
            tableBody={
              <TableBodyReturnAsset
                asset={returnAssetGlobal.returnAsset.returnAsset}
