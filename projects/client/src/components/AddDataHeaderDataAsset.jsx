...
export default function AddDataHeaderDataAsset({
  ...
  desc,
  isHiddenAddAsset,
  isHiddenAddTransferAsset,
  isHiddenAddReturnAsset,
  addButtonText,
  addButtonText2,
  addButtonText3,
  onAddClick,
  ...
  console.log("isHiddenAddAsset", isHiddenAddAsset);
  console.log("isHiddenAddTransferAsset", isHiddenAddTransferAsset);
  console.log("isHiddenAddReturnAsset", isHiddenAddReturnAsset);

  let isHidden = false;
  // let isHiddenAddAsset = false;
  // let isHiddenAddTransferAsset = false;
  // let isHiddenAddReturnAsset = false;
