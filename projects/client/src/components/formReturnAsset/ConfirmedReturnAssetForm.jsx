...
export default function ConfirmedReturnAssetForm({
  ...
  console.log("detail rt", detailData);
          ...
          <div className="space-y-6 sm:space-y-5">
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div className="mt-1 sm:col-span-2 sm:mt-0">
                : {detailData && detailData[0] && detailData[0].cabangOut}
              </div>
            </div>
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div className="mt-1 sm:col-span-2 sm:mt-0">
                : {detailData && detailData[0] && detailData[0].cabangIn}
              </div>
            </div>
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div className="mt-1 sm:col-span-2 sm:mt-0">
                <div className="mt-1 sm:col-span-2 sm:mt-0">
                  :{" "}
                  {detailData && detailData[0] && detailData[0].CreatedTransfer}
                </div>{" "}
              </div>
            </div>
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
