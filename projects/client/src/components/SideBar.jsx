                            ...
                            <Link
                              ...
                              className={classNames(
                                item.path === currentPath
                                  ? "bg-indigo-400 text-gray-900 group flex items-center px-4 py-2 text-sm font-medium rounded-md"
                                  : "text-indigo-100 hover:bg-indigo-600 group flex items-center px-4 py-2 text-sm font-medium rounded-md"
                              )}
                            >
                              {item.icon === "HomeIcon" && (
                                <HomeIcon
                              ...
                              {item.icon === "WrenchScrewdriverIcon" && (
                                <WrenchScrewdriverIcon
                                  className="mr-3 h-6 w-6 flex-shrink-0 text-indigo-300"
                                  aria-hidden="true"
                                />
                              ...
                              {({ open }) => (
                                <>
                                  ...
                                  userGlobal.role !== "Super Admin" ? (
                                    ...
                                    <Disclosure.Button className="group flex items-center px-4 py-2 text-sm font-medium rounded-md text-indigo-100 hover:bg-indigo-600">
                                      {item.icon === "HomeIcon" && (
                                        <HomeIcon
                                          className="mr-3 h-6 w-6 flex-shrink-0 text-indigo-300"
                                          aria-hidden="true"
                                        ...
                                        <Link
                                          ...
                                          className={classNames(
                                            subItem.path === currentPath
                                              ? "bg-indigo-400 text-gray-900 group flex items-center px-12 py-2 text-sm font-medium rounded-md"
                                              : "text-indigo-100 hover:bg-indigo-600 group flex items-center px- py-2 text-sm font-medium rounded-md"
                                          )}
                                        >
                                          {subItem.name}
                                        </Link>
                        ...
                        {({ open }) => (
                          <>
                            ...
                            userGlobal.role !== "Super Admin" ? (
                              ...
                              <Disclosure.Button className="group flex items-center pl-4 py-2 text-sm font-medium rounded-md text-indigo-100 hover:bg-indigo-600">
                                {item.icon === "HomeIcon" && (
                                  <HomeIcon
                                    className="mr-3 h-6 w-6 flex-shrink-0 text-indigo-300"
                                    aria-hidden="true"
                            ...
                            <Disclosure.Panel className="space-y-1">
                              {item.m_sub_menus.length &&
                                item.m_sub_menus.map((subItem) => (
                                  <Link
                                    key={subItem.name}
                                    to={subItem.path}
                                    className={classNames(
                                      subItem.path === currentPath
                                        ? "bg-indigo-400 text-gray-900 group flex items-center px-12 py-2 text-sm font-medium rounded-md"
                                        : "text-indigo-100 hover:bg-indigo-600 group flex items-center px-12 py-2 text-sm font-medium rounded-md"
                                    )}
                                  >
                                    {subItem.name}
                                  </Link>
